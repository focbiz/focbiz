...
import { globalThisPolyfill } from '@focbiz/utils'
...
export class Cursor {
  ...
  constructor(engine: Engine) {
    ...
    loong({
      ...
      dragStartScrollOffset: this.dragStartScrollOffset,
      dragEndPosition: this.dragEndPosition,
      dragEndScrollOffset: this.dragEndScrollOffset,
      view: this.view
    })
  }
